 ...
 *    加载远程URL配置 加载缓存到  本地文件系统，后面线程、进程直接去读取本地缓存配置 
 * @author  kaiyi.liu
 * @date 2013-6-4 下午3:15:59 
 *
 */
public class RowLoadURLCacheByFileFactory implements RowLoadByCache<URL,File,List<Map<String, Object>>>{

	// 远程 load Url Text
	private RowLoad<URL,List<Map<String, Object>>> load = new RowLoadURL(); ;
	...
	@Override
	public RowLoad<URL, List<Map<String, Object>>> getRowLoad() {
		return this.load ;
	}
