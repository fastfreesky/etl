 ...
 * 
 */
public class RowLoadDBCacheByFileFactory implements
		RowLoadByCache<Connection, File, List<Map<String, Object>>> {
	
	// 远程 load Url Text
	private RowLoad<Connection, List<Map<String, Object>>> load = new RowLoadDB();
	...
	@Override
	public void setSource(Connection f) {
		load.setSource(f);
	}
	...
	@Override
	public RowLoad<Connection, List<Map<String, Object>>> getRowLoad() {
		return this.load;
	}
