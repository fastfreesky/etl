...
import com.ccindex.factory.bean.DefaultBean;
...
public class DefaultProcess implements Process {
	...
	public int processing(String task, Bean bean, Output out,String... args) throws Exception {
		
		if (bean == null)
			return 0;
		
		DefaultBean fb = (DefaultBean) bean;
